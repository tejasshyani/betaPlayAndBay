...
<div class="listing_text">
                        ...
                        <p><a href="<?php echo osc_item_url() ; ?>"><?php echo osc_item_category() ; ?> - <?php echo osc_item_city(); ?> (<?php echo osc_item_region(); ?>) - <?php echo osc_format_date(osc_item_pub_date()); ?> 18000 руб. 
						<?php if( osc_price_enabled_at_items() ) { echo osc_format_price(osc_item_price()); } ?><br><br>
						<?php echo osc_highlight( strip_tags( osc_item_description()) ,250) ; ?></a></p>
                    </div>
					<div class="clear"></div>
					<?php if($admin){ ?>
