    ...
    <div style="padding: 0 20px 20px;">
        <div>
            <fieldset>
                ...
                <p>
                    <?php _e('In most cases you will not have to edit any files, as the links are added with javascript. ', 'osclass_pm'); ?>
                </p>
                <h2>
                    <?php _e('The links are not showing up on my site now what?', 'osclass_pm'); ?>
                </h2>
                <p>
                    <?php _e('You need to add this line of code to your item.php file.','osclass_pm'); ?>
                    <pre><&#63;php osclass_pm_link(); &#63;></pre>
                    <?php _e('The above function can also take a variable which can be used for setting the class of the link. Ex. for the repurpose theme you could use \'btn primary\' to show the link the same as the rest of the buttons.','osclass_pm'); ?>
                </p>
                <h2>
