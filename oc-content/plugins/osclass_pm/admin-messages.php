...
?>
    ...
    <strong><?php echo __('Message: ', 'osclass_pm') . osc_highlight($pm['pm_subject'], 50); ?></strong>
      ...
      <?php if(Params::getParam('box') == 'inbox') { ?>
         <a href="<?php echo osc_admin_base_url(true) . '?page=plugins&action=renderplugin&file=osclass_pm/admin-inbox.php'; ?>"><?php __('Back to inbox','osclass_pm') ?></a>
      <?php } elseif(Params::getParam('box') == 'outbox') { ?> 
         <a href="<?php echo osc_admin_base_url(true) . '?page=plugins&action=renderplugin&file=osclass_pm/admin-outbox.php'; ?>"><?php __('Back to outbox','osclass_pm') ?></a>
      <?php } ?> 
      <br />
      <br />
      <div class="pm_main">
