...
<div id="item-content">
    ...
    <?php if( osc_images_enabled_at_items() ) { ?>
        ...
        <div class="item-photos">
            <a href="<?php echo osc_resource_url(); ?>" class="main-photo" rel="image_group" title="<?php _e('Image', 'bender_black'); ?> <?php //--ribr 19092013--echo $i+1;?> / <?php echo osc_count_item_resources();?>">
    ...
    <div id="description">
        ...
        <?php echo osc_item_views() ; ?> <?php _e('views', 'bender_black'); ?>
        <p class="contact_button">
            ...
            <?php } ?>
			<?php watchlist(); ?>
			<?php// osclass_pm_link('btn primary'); ?>
    ...
    <div id="useful_info" class="bordered-box">
        ...
        <div class="similar_ads">
            ...
            <ul class="listing-card-list <?php echo /*--ribr 19092013--$class.*/ (osc_item_is_premium()?" premium":"") ; ?>" id="related-card-list">
                <?php
                $i = 0;
