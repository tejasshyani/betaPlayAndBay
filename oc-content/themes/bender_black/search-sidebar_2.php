...
<div class="filters">
    <form action="<?php echo osc_base_url(true); ?>" method="get" onSubmit="return doSearch()" class="nocsrf">
        ...
        <fieldset>
            <h3><?php _e('Show only', 'bender_black') ; ?></h3>
            <div class="row">
                <input type="checkbox" name="bPic" id="withPicture" value="1" <?php echo (osc_search_has_pic() ? 'checked' : ''); ?> />
                <label for="withPicture"><?php _e('Show only items with pictures', 'bender_black') ; ?></label>
            </div>
        </fieldset>
        <?php } ?>
        ...
        <fieldset>
            <div class="row ">
                <h3><?php _e('Category', 'bender_black') ; ?></h3>
                <ul class="category">
        ...
        <div class="actions">
            <button type="submit"><?php _e('Apply', 'bender_black') ; ?></button>
        </div>
    </form>
    <?php //osc_alert_form() ; ?>
</div>
