<?php
    ...
    bender_black_add_boddy_class('error not-found');
    osc_current_web_theme_path('header.php') ;
?>
<div class="flashmessage-404">
    <h1><?php _e("Sorry but I can't find the page you're looking for", 'bender_black') ; ?></h1>

    <p><?php _e("Let us help you, we have got a few tips for you to find it.", 'bender_black') ; ?></p>
    <ul>
        <li>
            <?php _e("<strong>Search</strong> for it:", 'bender_black') ; ?>
            <form action="<?php echo osc_base_url(true) ; ?>" method="get" class="search">
                ...
                <fieldset class="main">
                    ...
                    <button type="submit" class="ui-button ui-button-middle"><?php _e('Search', 'bender_black') ; ?></button>
                </fieldset>
            </form>
        </li>
        <li><?php _e("<strong>Look</strong> for it in the most popular categories.", 'bender_black') ; ?>
